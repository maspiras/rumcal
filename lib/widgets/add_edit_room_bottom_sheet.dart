                              ...
                              if (formKey.currentState!.validate()) {
                                if (roomNameController.text.isEmpty) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content:
                                          Text(StringUtils.roomNameRequired),
                                      backgroundColor: ColorUtils.blue,
                                    ),
                                  );
                                  return;
...
Future<dynamic> addEditRoomBottomSheet(BuildContext context,
                      ...
                      onPressed: processing
                          ...
                          : () async {
                              if (formKey.currentState!.validate()) {
                                ...
                                if (room == null) {
                                  bloc.add(AddRoom(RoomModel(
                                    roomName: roomNameController.text,
                                    roomDesc: roomDescController.text,
                                    userId: int.parse(userId),
                                  )));
                                } else {
                                  bloc.add(UpdateRoom(RoomModel(
                                    id: room.id,
                                    roomName: roomNameController.text,
                                    roomDesc: roomDescController.text,
                                    userId: int.parse(userId),
                                ...
                                // ⬅️ IMPORTANT: non-null result pass karo
